<?php
namespace Tritiyo\Task\Repositories\TaskVehicle;

use Tritiyo\Task\Models\TaskVehicle;

class TaskVehicleEloquent implements TaskVehicleInterface
{
    private $model;

    /**
     * TaskSiteEloquent constructor.
     * @param TaskSiteInterface $model
     */
    public function __construct(TaskVehicle $model)
    {
        $this->model = $model;
    }
