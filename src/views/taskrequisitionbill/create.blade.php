                    ...
                    <div class="column is-12">
                            ...
                            <div class="column is-2">
                                <div class="field">
                                    ...
                                    <div class="control">
                                        ...
                                        <input type="hidden" name="project_id" class="input is-small" value="{{$task->project_id}}"/>
                            ...
                            <div class="column">
                                <div class="field">
                                    ...
                                    <div class="control">
                                        ...
                                        <input type="hidden" name="project_manager_id" class="input is-small" value="{{$task->site_head}}"/>
                                        <input type="text"  class="input is-small" value="{{$projectManager->name}}" readonly/>
                                    </div>
                                </div>
                            </div>
                            <div class="column">
                        ...
                        <fieldset class="pb-5">
                            <label>Vehicle Information
                                <a href="{{route('taskvehicle.create')}}?task_id={{$task_id}}&information=vehicleinformation" class="is-link is-size-7 is-small"> Edit </a>
                            </label>
                                    ...
                                    <div class="column is-3">
                                        <div class="field">
                                            ...
                                            <div class="control">
                                                ...
                                                <input type="hidden" name="vehicle_id" class="input is-small" value="{{$veh->vehicle_id}}">
                                                <input type="text" name="" class="input is-small" value="{{$vehicleName}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <fieldset class="pb-5">
                            <label>Material Information
                                <a href="{{route('taskmaterial.create')}}?task_id={{$task_id}}&information=materialInformation" class="is-link is-size-7 is-small"> Edit </a>
                            </label>
                                    ...
                                    <div class="column is-3">
                                        <div class="field">
                                            ...
                                            <div class="control">
                                                ...
                                                <input type="hidden" name="material_id" class="input is-small" value="{{$mat->material_id}}">
                                                <input type="text" name="" class="input is-small" value="{{$materialName}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="columns">
                            <div class="column">
                                <div class="field">
                                    ...
                                    <div class="control">
                                        {{ Form::number('da_amount', NULL, ['class' => 'input is-small',  'placeholder' => 'Enter DA amount...', 'v-model' => 'da_amount', 'min' => '0', 'max' => '800']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="column">
                        ...
                        <div id="ta_wrap">
                            <div class="columns">
                                ...
                                <div class="column is-3">
                                    <input type="text" name="where_to_where" class="input is-small"  placeholder="Where to Where" required/>
                                </div>
                                <div class="column is-2">
                                    <div class="control">
                                ...
                                <div class="column is-2">
                                    <input class="input is-small" name="ta_amount" type="number" min="0" step=".01" placeholder="TA Amount" required/>
                                </div>
                                <div class="column">
                                    <input class="input is-small" name="ta_note" type="text"  placeholder="TA Note" required/>
                                </div>
                            </div>
                        </div>
                        <!-- End Transport -->
                        ...
                        <div id="pa_wrap">
                            <div class="columns">
                                ...
                                <div class="column is-2">
                                    <input class="input is-small" name="pa_amount" type="number" min="0" step=".01"
                                           placeholder="PA Amount" required/>
                                </div>
                                <div class="column">
                                    <input class="input is-small" name="pa_note" type="text"
...
@section('cusjs')
    ...
    <script id="ta_form" type="text/template">
        <div class="columns">
            ...
            <div class="column is-3">
                <input type="text" name="where_to_where"
            ...
            <div class="column is-2">
                <input class="input is-small" name=""ta_amount type="number" min="0" step=".01"
                       placeholder="TA Amount" required/>
            </div>
            <div class="column">
                <input class="input is-small" name="ta_note" type="text"
