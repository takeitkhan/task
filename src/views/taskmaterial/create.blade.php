                ...
                <div id="myTable">
                    <div class="columns s{{$mat->id}}">
                        <div class="column is-4">
                            <div class="field">
                                {{ Form::label('material_id', 'Vehicle', array('class' => 'label')) }}
                                <div class="control">
                                    <select name="material_id[]" id="material_select" class="input" required>
                                        <option value="">Select Vehicle</option>
                                        @foreach($materials as $material)
                                            <option value="{{$material->id}}" {{ $mat->material_id == $material->id ? 'selected' : '' }} >{{$material->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
            ...
            @else
                <div id="myTable">
                    <div class="columns">
                        ...
                        <div class="column is-5">
                            <label for="material_qty" class="label">Materail Qty</label>
