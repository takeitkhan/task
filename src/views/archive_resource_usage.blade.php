            ...
            <div class="card tile is-child xquick_view">
                <div class="card-content">
                    <div class="column is-12 mb-4">
                        <form method="get" action="{{route('archive.resource.usage',)}}">
                            @csrf

                            <div class="field has-addons">
                                <a href="{{route('archive.resource.usage.excel')}}?daterange={{request()->get('daterange') ?? NULL}}"
                        ...
                        <div class="columns">
                            ...
                            <div class="column is-8 mx-auto">
                                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                                    <tr>
                                        <th colspan="7">Used</th>
                                    </tr>
                                    <tr>
                                        <th class="has-background-primary-dark">Emp ID</th>
                                    ...
                                    @foreach ($used as $data)
                                        ...
                                        <tr>
                                            <td style="">
                                                <a target="_blank"
                                                   href="{{ route('hidtory.user', $data['id']) }}">
                                                    {{ $data['emp_no'] }}
                                                </a>
                                            </td>
                                            <td style="">
                                            ...
                                            <td>{{ $data['designationName'] ?? NULL }}</td>
                                            <td>
                            ...
                            <div class="column is-4 mx-auto">
                                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                                    <tr>
                                        <th colspan="4">Not Used</th>
                                    </tr>
                                    <tr>
                                        <th class="has-background-danger">Emp No</th>
